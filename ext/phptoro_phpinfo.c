 ...
 *
 * Call phptoro_phpinfo_install() after RiphtSapi::instance().
 */
...
/*
 * Captures stock phpinfo() HTML output, then injects phpToro CSS
 * right before </style> so our styles override the defaults.
 */
...
/*
 * Replace built-in phpinfo() with our branded version.
 * Must be called AFTER PHP startup (after RiphtSapi::instance()).
 */
